 ...
 *
 */
public class GlobalStatusAppDao {
    // ------------------------------------------ Private Fields
    private static final String LOG_HASH = GlobalStatusAppDao.class.getSimpleName();
    
    private final ILogFacility mLogFacility;

    // -------------------------------------------- Constructors
    public GlobalStatusAppDao(ILogFacility logFacility) {
